...
示例：
  # 完整视频，场景检测 + 字幕
  python extract_frames.py BV19E411D78Q --page 9 --mode scene --subtitle

  # 只下载 5:00-10:00 片段，固定 20s 间隔 + 字幕
  python extract_frames.py BV19E411D78Q --page 9 --start 5:00 --end 10:00 --mode fixed --interval 20 --subtitle

  # 只下载字幕，不抽帧
  python extract_frames.py BV19E411D78Q --page 9 --subtitle --mode fixed --interval 9999
"""
